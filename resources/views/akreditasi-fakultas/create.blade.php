...
@section('title', 'Tambah Akreditasi Fakultas')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Akreditasi Fakultas</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Akreditasi Fakultas</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('akreditasi-fakultas.store') }}" method="POST" id="akreditasiForm">
                @csrf
