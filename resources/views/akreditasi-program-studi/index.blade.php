...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('akreditasi-program-studi.exportExcel', request()->query()) }}" class="btn btn-success btn-icon-split mr-2">
                <span class="icon text-white-50">
                    <i class="fas fa-file-excel"></i>
                </span>
                <span class="text">Export Excel</span>
            </a>
            <a href="{{ route('akreditasi-program-studi.exportPdf', request()->query()) }}" class="btn btn-danger btn-icon-split mr-2">
                <span class="icon text-white-50">
