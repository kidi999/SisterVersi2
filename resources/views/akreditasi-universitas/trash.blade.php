...
@section('title', 'Recycle Bin - Akreditasi Universitas')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-trash-restore"></i> Recycle Bin - Akreditasi Universitas
        </h1>
                ...
                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('akreditasi-universitas.restore', $item->id) }}" 
                                ...
                                <form action="{{ route('akreditasi-universitas.force-delete', $item->id) }}" 
                                      method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
