...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="bi bi-speedometer2"></i> Dashboard Admin Fakultas</h2>
            <p class="text-muted">{{ $fakultas->nama_fakultas ?? 'Fakultas' }} - {{ Auth::user()->name }}</p>
        </div>
    </div>
        ...
        <div class="col-xl-6 mb-3">
            <div class="card shadow h-100">
                <div class="card-header">
                    <h6 class="mb-0"><i class="bi bi-info-circle"></i> Info Fakultas</h6>
                </div>
                <div class="card-body">
                    <p class="mb-1"><strong>Nama:</strong> {{ $fakultas->nama_fakultas ?? '-' }}</p>
                    <p class="mb-1"><strong>Kode:</strong> {{ $fakultas->kode_fakultas ?? '-' }}</p>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('program-studi.index') }}" class="btn btn-outline-primary btn-block">
                                <i class="bi bi-mortarboard"></i> Kelola Program Studi
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('mahasiswa.index') }}" class="btn btn-outline-success btn-block">
                                <i class="bi bi-people"></i> Kelola Mahasiswa
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('dosen.index') }}" class="btn btn-outline-info btn-block">
                                <i class="bi bi-person-workspace"></i> Kelola Dosen
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('mata-kuliah.index') }}" class="btn btn-outline-warning btn-block">
                                <i class="bi bi-book"></i> Kelola Mata Kuliah
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('jadwal-kuliah.index') }}" class="btn btn-outline-secondary btn-block">
                                <i class="bi bi-calendar3"></i> Jadwal Kuliah
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('kelas.index') }}" class="btn btn-outline-primary btn-block">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('pembayaran-mahasiswa.index') }}" class="btn btn-outline-info btn-block">
