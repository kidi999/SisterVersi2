            ...
            <form action="{{ route('dosen.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="level_dosen" id="level_dosen" class="form-control @error('level_dosen') is-invalid @enderror" required>
                        ...
                        <option value="universitas" {{ old('level_dosen') == 'universitas' ? 'selected' : '' }}>Dosen Universitas</option>
                        <option value="fakultas" {{ old('level_dosen') == 'fakultas' ? 'selected' : '' }}>Dosen Fakultas</option>
                        <option value="prodi" {{ old('level_dosen', 'prodi') == 'prodi' ? 'selected' : '' }}>Dosen Program Studi</option>
                    </select>
                    @error('level_dosen')
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="nama_dosen" id="nama_dosen" class="form-control @error('nama_dosen') is-invalid @enderror" 
                               value="{{ old('nama_dosen') }}" required maxlength="100">
                        @error('nama_dosen')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
$(document).ready(function() {
    console.log('=== Dosen Create Form Initialized ===');
