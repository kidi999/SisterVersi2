                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_kelas" id="nama_kelas" 
                                           ...
                                           placeholder="Contoh: Kelas A" required>
                                    @error('nama_kelas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="tahun_ajaran" id="tahun_ajaran" class="form-select @error('tahun_ajaran') is-invalid @enderror" required>
                                        ...
                                        @foreach($tahunAkademik as $ta)
                                            <option value="{{ $ta->tahun_ajaran }}" {{ old('tahun_ajaran') == $ta->tahun_ajaran ? 'selected' : '' }}>
                                                {{ $ta->tahun_ajaran }}
                                            </option>
                                        @endforeach
                                    </select>
            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>Pilih mata kuliah yang akan diampu</li>
                        <li>Tentukan dosen pengampu kelas</li>
                        <li>Set kapasitas sesuai ketersediaan ruangan</li>
                        <li>Pastikan tahun ajaran dan semester sudah benar</li>
                    </ul>
                </div>
            </div>
        </div>
