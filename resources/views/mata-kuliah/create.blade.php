            ...
            <form action="{{ route('mata-kuliah.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="level_matkul" id="level_matkul" class="form-control @error('level_matkul') is-invalid @enderror" required>
                        ...
                        <option value="universitas" {{ old('level_matkul') == 'universitas' ? 'selected' : '' }}>Mata Kuliah Universitas</option>
                        <option value="fakultas" {{ old('level_matkul') == 'fakultas' ? 'selected' : '' }}>Mata Kuliah Fakultas</option>
                        <option value="prodi" {{ old('level_matkul', 'prodi') == 'prodi' ? 'selected' : '' }}>Mata Kuliah Program Studi</option>
                    </select>
                    @error('level_matkul')
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="kode_mk" id="kode_mk" class="form-control @error('kode_mk') is-invalid @enderror" 
                               value="{{ old('kode_mk') }}" required maxlength="20">
                        @error('kode_mk')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="nama_mk" id="nama_mk" class="form-control @error('nama_mk') is-invalid @enderror" 
                               value="{{ old('nama_mk') }}" required maxlength="100">
                        @error('nama_mk')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="sks" id="sks" class="form-control @error('sks') is-invalid @enderror" 
                               value="{{ old('sks') }}" required min="1" max="6">
                        @error('sks')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="semester" id="semester" class="form-control @error('semester') is-invalid @enderror" 
                               value="{{ old('semester') }}" required min="1" max="14">
                        @error('semester')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="jenis" id="jenis" class="form-control @error('jenis') is-invalid @enderror" required>
                            ...
                            <option value="Wajib" {{ old('jenis', 'Wajib') == 'Wajib' ? 'selected' : '' }}>Wajib</option>
...
$(document).ready(function() {
    console.log('=== Mata Kuliah Create Form Initialized ===');
