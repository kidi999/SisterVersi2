...
class PembayaranMahasiswaExportTest extends TestCase
{
    use RefreshDatabase;

    public function test_pembayaran_mahasiswa_export_excel_returns_xls(): void
    {
        ...
        $mahasiswa = Mahasiswa::create([
            ...
            'nim' => '2302001',
            'nama_mahasiswa' => 'Mahasiswa Bayar',
            'jenis_kelamin' => 'P',
            'email' => 'bayar.mhs@example.test',
            'tahun_masuk' => '2023',
            'semester' => 3,
            'ipk' => 3.10,
            'status' => 'Aktif',
        ...
        $tagihan = TagihanMahasiswa::create([
            ...
            'nomor_tagihan' => 'TGH/2025/01/00002',
        ...
        PembayaranMahasiswa::create([
            ...
            'mahasiswa_id' => $mahasiswa->id,
            'nomor_pembayaran' => 'PMB/2025/01/00001',
            'jumlah_bayar' => 250000,
        ...
        $response = $this->actingAs($admin)->get(route('pembayaran-mahasiswa.exportExcel'));

        $response->assertOk();
        $this->assertTrue(str_contains($response->headers->get('Content-Type'), 'application/vnd.ms-excel'));
        $response->assertSee('PMB/2025/01/00001');
    }

    public function test_pembayaran_mahasiswa_export_pdf_returns_pdf(): void
    {
        $admin = User::factory()->withSuperAdminRole()->create();

        $response = $this->actingAs($admin)->get(route('pembayaran-mahasiswa.exportPdf'));
